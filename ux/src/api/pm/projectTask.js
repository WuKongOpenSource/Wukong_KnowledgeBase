 ...
 * @param {*} data
 */
export function setColorAPI(data) {
  return request({
    url: 'projectTask/setColor',
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    },
 ...
 * @param {*} data
 */
export function queryBoardTaskPageAPI(data) {
  return request({
    url: 'projectBoardTask/queryBoardTaskPage',
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    },
 ...
 * @param {*} data
 */
export function queryViewTaskChildAllBoardListAPI(data) {
  return request({
    url: 'projectBoardTask/queryAllBoradList',
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    },
 ...
 * @param {*} data
 */
export function projectTaskQueryProjectIterationListAPI() {
  return request({
    url: 'projectTask/queryProjectIterationList',
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    }
