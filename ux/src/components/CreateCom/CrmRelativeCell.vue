...
export default {
  ...
  methods: {
    ...
    getIndexRequest() {
      return {
        leads: crmLeadsIndexAPI,
        customer: crmCustomerIndexAPI,
        contacts: crmContactsIndexAPI,
        business: crmBusinessIndexAPI,
        contract: crmContractIndexAPI,
        product: crmProductIndexAPI,
        receivables: crmReceivablesIndexAPI,
        visit: crmReturnVisitIndexAPI,
        invoice: crmInvoiceIndexAPI,
        receivablesPlan: crmReceivablesPlanIndexAPI
      }[this.dataType]
    },
    /**
     * 获取基础参数
