...
import { jxcPurchaseQueryByIdAPI } from '@/api/jxc/purchase'
import { jxcRetreatQueryByIdAPI } from '@/api/jxc/retreat'
import { jxcSaleQueryByIdAPI } from '@/api/jxc/sale'
import { jxcSaleReturnQueryByIdAPI } from '@/api/jxc/saleReturn'
import { jxcPaymentQueryByIdAPI } from '@/api/jxc/payment'
import { jxcCollectionQueryByIdAPI } from '@/api/jxc/collection'
import { jxcInventoryQueryByIdAPI } from '@/api/jxc/inventory'
import { jxcAllocationQueryByIdAPI } from '@/api/jxc/allocation'
...
export default {
  methods: {
    ...
    flowGetCRMDetailRequestFun(createType) {
      return {
        contract: crmContractReadAPI,
        receivables: crmReceivablesReadAPI,
        invoice: crmInvoiceReadAPI
      }[createType]
    },
     ...
     * @return {*}
     */
    flowGetJXCDetailRequestFun(createType) {
      return {
        jxc_purchase: jxcPurchaseQueryByIdAPI,
        jxc_retreat: jxcRetreatQueryByIdAPI,
        jxc_sale: jxcSaleQueryByIdAPI,
        jxc_saleReturn: jxcSaleReturnQueryByIdAPI,
        jxc_payment: jxcPaymentQueryByIdAPI,
        jxc_collection: jxcCollectionQueryByIdAPI,
        jxc_inventory: jxcInventoryQueryByIdAPI,
        jxc_allocation: jxcAllocationQueryByIdAPI
      }[createType]
    },
